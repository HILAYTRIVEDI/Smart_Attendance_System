...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global cursor         
            connection = pymysql.connect(host='localhost', user='a', password='hilay', db='manually_fill_attendance')
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/a/Desktop/image processing project/FINAL/Attendace_management_system-master'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/a/Desktop/image processing project/FINAL/Attendace_management_system-master-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='localhost', user='root', password='hilay', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='snow')
                cs = 'C:/Users/a/Desktop/image processing project/FINAL/Attendace_management_system-master' + fileName
